namespace Lab1
{
    partial class Figures 
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonUndo = new Button();   // Lab6: Undo button for the Command pattern
            ...
            // ── buttonUndo ── (Lab6: Command pattern)
            buttonUndo.Location = new Point(12, 450);
            buttonUndo.Name = "buttonUndo";
            buttonUndo.Size = new Size(132, 23);
            buttonUndo.Text = "Undo";
            buttonUndo.UseVisualStyleBackColor = true;
            buttonUndo.Click += buttonUndo_Click;

            // ── buttonSave ──
            buttonSave.Location = new Point(12, 480);
            ...
            // ── buttonLoad ──
            buttonLoad.Location = new Point(12, 510);
        ...
        private Button buttonUndo;   // Lab6: Undo button for the Command pattern
